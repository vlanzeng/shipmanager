 ...
 * 
 */
public interface MorderDao extends CrudRepository<Order, Long> {
	@Modifying
	...
	@Query(value="select fund from t_user_bank where user_id=?1", nativeQuery=true)
	Double queryUserBankYe(Long userId);
