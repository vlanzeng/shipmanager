		...
		<div id="coupon_query_id">
			<table>
				<tr style="height: 40px;">
					<td width="100px"><select name="select" id="o_w_status"
						style="width: 100px">
					...
					<td width="100px"><input type="text" placeholder="发布人手机号" /></td>
					<td width="100px"><input type="text" placeholder="搜索...." /></td>
...
<script type="text/javascript">
	...
	function add(){
		...
		var jsonStr  ={"infoType":1,"action":action,"infoTypeOne":infoTypeOne,"infoTypeTwo":infoTypeTwo,"price":price,"address":address,"title":title,"descri":descri,"linkMan":linkMan};
		$.post('${ctx}/m/info/add',
