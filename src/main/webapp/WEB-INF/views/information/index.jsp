					...
					<tr style="height: 40px;">
						...
						<td width="150px">
							<select name="type" id="c_type" style="width: 200px">
								<option value="1" selected="selected">黄沙</option>
								<option value="2">中砂</option>
								<option value="3">细砂</option>
							</select>
						</td>
						<td width="100px"><span>行为:</span></td>
						<td width="150px">
							<select name="type" id="c_type" style="width: 200px">
						...
						<td width="100px"><span>标题:</span></td>
						<td width="150px"><input id="title" type="text" style="width: 120px"/></td>
						<td width="100px"><span>描述:</span></td>
						<td width="150px"><input id="c_face" type="text" style="width: 120px"/></td>
						<td width="100px"><span>图片:</span></td>
						<td width="150px">
							<select name="type" id="c_type" style="width: 200px">
