...
<script type="text/javascript">
	...
	function add(){
		...
		var jsonStr  ={"infoType":4,"action":action,"infoTypeOne":infoTypeOne,"infoTypeTwo":infoTypeTwo,"price":price,"address":address,"title":title,"descri":descri,"linkMan":linkMan};
		$.post('${ctx}/m/info/add',
